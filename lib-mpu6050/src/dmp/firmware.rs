...
/// This glorious dump of the v2.0 DMP firmware comes from Jeff Rowberg's C++ libary: 
/// https://github.com/jrowberg/i2cdevlib/blob/master/Arduino/MPU6050/MPU6050_6Axis_MotionApps20.cpp
///
#[cfg(feature = "dmp20")]
pub static DMP_FIRMWARE: [u8; 1929] = [
    /* bank # 0 */
...
/// Dump of v6.12 DMP firmware from Jeff Rowberg's C++ libary: 
/// https://github.com/jrowberg/i2cdevlib/blob/master/Arduino/MPU6050/MPU6050_6Axis_MotionApps612.cpp
/// 
#[cfg(feature = "dmp612")]
pub static DMP_FIRMWARE: [u8; 3062] = [
    /* bank # 0 */
...
pub static DMP_FIRMWARE: [u8; 1] = [ 0x00 ];
